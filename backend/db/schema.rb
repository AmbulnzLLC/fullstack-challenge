...
ActiveRecord::Schema[7.0].define(version: 2023_10_24_153706) do
  ...
  create_table "pizza_ingredients", force: :cascade do |t|
    ...
    t.index ["item_id"], name: "index_pizza_ingredients_on_item_id"
  end

  add_foreign_key "order_items", "items"
  add_foreign_key "order_items", "orders"
  add_foreign_key "pizza_ingredients", "ingredients"
  add_foreign_key "pizza_ingredients", "items"
end
